...
*= $8925
StateCityMap_MashmallowManAttackIncoming:
{
    ldx #$0e
    loop: // $8927
    {
...
*= $8970
StateCityMap_MashmallowManDestroyBuilding:
{
...
*= $89dc
StateCityMap_MashmallowManDefeated:
{
    lda #$2f
    sta $2f
    lda #$30
...
*= $8a03
StateCityMap_MoveGhostsToOriginalPositions:
{
    ldx #$0e
